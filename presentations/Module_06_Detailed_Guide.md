...
**Text Content**
- **DISPLAY HEADER:** THE CONFIDENCE INTERPRETER
- **BODY:**
...
- Each icon has a subtle Electric Blue (#44B6E5) highlight.

**Text Content**
- **DISPLAY HEADER:** INVISIBLE INTELLIGENCE
- **BODY:**
  - AI is not just robots; it's a powerful tool that you use every day.
  - It recommends videos, unlocks your phone, and helps navigate traffic.
...
- **Right Panel:** A dynamic, web-like neural network, representing AI learning from examples (images of cats).

**Text Content**
- **DISPLAY HEADER:** RULES VS. LEARNING
- **BODY:**
...
- The path from eye to brain is a soft, organic line.

**Text Content**
- **DISPLAY HEADER:** BIOLOGICAL VISION
- **BODY:**
  - Your eyes capture light (pixels).
  - Your brain, trained since birth, instantly recognizes patterns, shapes, and objects.
...
- The path is a digital, straight line in Electric Blue (#44B6E5).

**Text Content**
- **DISPLAY HEADER:** ARTIFICIAL VISION
- **BODY:**
  - The camera captures pixels.
  - The Neural Network processes these pixels, looking for patterns it learned during training.
  - The output is a label and a confidence score.
...
- Data flows from left to right, highlighted by Electric Blue (#44B6E5) lines.

**Text Content**
- **DISPLAY HEADER:** THE DIGITAL BRAIN
- **BODY:**
  - A neural network is a collection of connected nodes, inspired by the human brain.
  - Each layer learns to recognize progressively more complex features (edges -> shapes -> objects).
...
- The AI Core glows brighter with each image it "consumes".

**Text Content**
- **DISPLAY HEADER:** LEARNING FROM DATA
- **BODY:**
  - Our AI model was trained on millions of images.
  - It learned to identify patterns by repeatedly being shown a picture and told "This is a car."
  - This is why AI can recognize objects it has never seen before in your classroom.
...
**Text Content**
- **DISPLAY HEADER:** THE BRAIN ON THE CHIP
- **BODY:**
  - This is not a normal camera.
  - The AI—the neural network—runs directly on the camera sensor itself.
...
**Text Content**
- **DISPLAY HEADER:** EDGE AI ADVANTAGE
- **BODY:**
  - **FAST:** No need to send data to the cloud. Decisions are instant.
  - **PRIVATE:** Images never leave the device.
  - **EFFICIENT:** Uses very little power.
...
- A callout from the marker says "87% Certain". The bar is colored Electric Blue (#44B6E5).

**Text Content**
- **DISPLAY HEADER:** THE LANGUAGE OF CERTAINTY
- **BODY:**
  - The AI never says "This is a dog."
  - It says, "I am 87% confident this is a dog."
  - This score, from 0.0 to 1.0, is the AI's measure of certainty.
...
- 2. A blurry, distant photo of a cat. Output: `CAT: 0.65` (Medium).
- 3. A picture of a toaster. Output: `CAT: 0.12` (Low/False).

**Text Content**
- **DISPLAY HEADER:** TRUST BUT VERIFY
- **BODY:**
  - **High Confidence (0.8+):** Very likely correct.
  - **Medium Confidence (0.5 - 0.8):** Possibly correct, but uncertain.
  - **Low Confidence (< 0.5):** Likely a mistake or "false positive."
...
- High-confidence cubes (glowing blue) pass through, while low-confidence cubes (dull grey) are blocked.

**Text Content**
- **DISPLAY HEADER:** SIGNAL FROM NOISE
- **BODY:**
...
## SLIDE 14: Bounding Boxes
**Visual Design**
- A simple line-art diagram of an object (a cup) on a grid.
- An Electric Blue (#44B6E5) box is drawn around it.
- The corners are labeled with coordinates: (x1, y1) and (x2, y2).

**Text Content**
- **DISPLAY HEADER:** WHERE IS THE OBJECT?
- **BODY:**
...
## SLIDE 15: Your Turn
**Visual Design**
- A final isometric view of the student at their desk, with the Raspberry Pi and camera.
- A holographic filter interface is projected above the camera, showing a slider for "Confidence Threshold".
- The student is shown adjusting the slider.

**Text Content**
- **DISPLAY HEADER:** BUILD YOUR INTERPRETER
- **BODY:**
